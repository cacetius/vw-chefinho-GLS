...
export default function LinhaVisual({ carros, onEdit }) {
  ...
  const estacoes = [
    ...
    { id: "zp1_piso", nome: "ZP1 - Piso", icon: "🔲", color: "from-blue-400 to-blue-500", categoria: "Montagem" },
    { id: "zp2_lateral", nome: "ZP2 - Lateral", icon: "🔳", color: "from-blue-500 to-blue-600", categoria: "Montagem" },
    { id: "zp3_teto", nome: "ZP3 - Teto", icon: "🏠", color: "from-blue-600 to-indigo-500", categoria: "Montagem" },
    { id: "zp4_portas", nome: "ZP4 - Portas", icon: "🚪", color: "from-indigo-500 to-indigo-600", categoria: "Montagem" },
    { id: "zp5_suspensao_dianteira", nome: "ZP5 - Susp. Diant.", icon: "🔧", color: "from-indigo-600 to-purple-500", categoria: "Montagem" },
    { id: "zp6_motor_cambio", nome: "ZP6 - Motor/Câmbio", icon: "⚙️", color: "from-purple-500 to-purple-600", categoria: "Montagem" },
    { id: "zp7_suspensao_traseira", nome: "ZP7 - Susp. Tras.", icon: "🔩", color: "from-purple-600 to-purple-700", categoria: "Montagem" },
    { id: "zp8_rodas_pneus", nome: "ZP8 - Rodas/Pneus", icon: "⭕", color: "from-purple-700 to-violet-600", categoria: "Montagem" },
    { id: "zp9_parachoque_dianteiro", nome: "ZP9 - Para-choque Diant.", icon: "🛡️", color: "from-violet-600 to-violet-700", categoria: "Montagem" },
    { id: "zp10_parachoque_traseiro", nome: "ZP10 - Para-choque Tras.", icon: "🛡️", color: "from-violet-700 to-fuchsia-600", categoria: "Montagem" },
    { id: "zp11_chicotes_eletricos", nome: "ZP11 - Chicotes", icon: "🔌", color: "from-fuchsia-600 to-fuchsia-700", categoria: "Montagem" },
    { id: "zp12_painel_instrumentos", nome: "ZP12 - Painel", icon: "📊", color: "from-fuchsia-700 to-pink-600", categoria: "Montagem" },
    { id: "zp13_bancos", nome: "ZP13 - Bancos", icon: "💺", color: "from-pink-600 to-pink-700", categoria: "Montagem" },
    { id: "zp14_vidros", nome: "ZP14 - Vidros", icon: "🪟", color: "from-pink-700 to-rose-600", categoria: "Montagem" },
    { id: "zp15_acabamento_interno", nome: "ZP15 - Acab. Interno", icon: "✨", color: "from-rose-600 to-rose-700", categoria: "Montagem" },
    { id: "zp16_capo_tampa", nome: "ZP16 - Capô/Tampa", icon: "📦", color: "from-rose-700 to-red-600", categoria: "Montagem" },
