    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 p-4 md:p-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="relative mb-8">
          <div className="h-48 bg-gradient-to-r from-[#001e50] via-[#0066b1] to-[#00b0f0] rounded-3xl shadow-2xl"></div>
          <div className="absolute -bottom-16 left-8 flex items-end gap-6">
            <div className="relative">
              <Avatar className="w-32 h-32 border-4 border-white shadow-xl bg-gradient-to-br from-[#001e50] to-[#0066b1]">
                {currentUser?.foto_perfil ? (
              ...
              <label 
                htmlFor="foto-upload" 
                className="absolute bottom-2 right-2 w-10 h-10 bg-blue-600 rounded-full flex items-center justify-center cursor-pointer hover:bg-blue-700 transition-all shadow-lg hover:scale-110"
              >
        ...
        <div className="mt-20">
          ...
          {uploading && (
            <Alert className="mb-6 bg-blue-50 border-blue-200 shadow-lg">
              ...
              <CardContent className="pt-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-4xl font-bold mt-1">{stats.pedidosFeitos}</p>
                  </div>
              ...
              <CardContent className="pt-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-4xl font-bold mt-1">{stats.tarefasConcluidas}</p>
                  </div>
                  <div className="w-16 h-16 bg-white/20 rounded-2xl flex items-center justify-center">
                    <Award className="w-8 h-8" />
                  </div>
              ...
              <CardContent className="pt-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-4xl font-bold mt-1">{stats.diasCadastro}</p>
                  </div>
                  <div className="w-16 h-16 bg-white/20 rounded-2xl flex items-center justify-center">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="flex justify-end pt-4">
                    <Button
                      type="submit"
                      disabled={saving}
                      className="bg-gradient-to-r from-[#001e50] to-[#0066b1] hover:from-[#001e50] hover:to-[#004d82] px-8 h-12 text-base font-semibold shadow-lg"
                    >
          ...
          {/* Dicas e Informações */}
          <Card className="mt-6 shadow-xl border-0 border-l-4 border-l-yellow-500">
