...
export default function MochilaMonitorPage() {
  ...
  const { data: auditorias = [] } = useQuery({
    ...
    queryFn: () => base44.entities.AuditoriaIndustrialProcesso.list('-created_date', 20),
    enabled: !!currentUser,
  });
  ...
  const modules = [
    ...
    { icon: ClipboardCheck, title: "AuditoriaIndustrial", subtitle: "Conformidade e qualidade", bg: "border-l-emerald-500", textColor: "text-emerald-600", path: "AuditoriaIndustrial", badge: null },
      ...
      <div>
        ...
        <div className="grid grid-cols-2 gap-2">
          ...
          >
            ...
            <span className="text-[10px] text-slate-400">AuditoriaIndustrial</span>
          </Button>
        </div>
      </div>
    </div>
